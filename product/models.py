...
class Products(models.Model):
    ...
    description = models.CharField(
        max_length=150, verbose_name="descripcion del producto"
    )
    ...
    category = models.ForeignKey(
        Category, on_delete=models.SET_NULL, null=True, verbose_name="categoria"
    )
    available = models.BooleanField(default=True, verbose_name="Disponibilidad")
    create = models.DateTimeField(
        auto_created=True, verbose_name="Fecha de creación", null=True
    )
